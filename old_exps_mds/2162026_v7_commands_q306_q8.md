# 2026-02-16 v7 Qwen3-0.6B Commands (Q4xN2 -> S8xN10)
...
python3 -m verl.trainer.main_ppo \
  ...
  trainer.rollout_data_dir='/workspace/verl/verl/qwen3_0.6b_dual_solver_v7_b8_n10' \
  trainer.logger='["console","wandb"]' \
  trainer.project_name='verl_grpo_v7_dual_loop_q306b' \
  trainer.experiment_name='qwen3_0.6b_dual_solver_v7_b8_n10' \
  ...
  | tee qwen3_0.6b_dual_solver_v7_b8_n10.log
```
...
python3 -m verl.trainer.main_ppo \
  ...
  trainer.critic_warmup=0 \
  trainer.log_val_generations=0 \
  trainer.rollout_data_dir='/workspace/verl/verl/qwen3_0.6b_dual_questioner_v7_b4_n2' \
  trainer.logger='["console","wandb"]' \
  trainer.project_name='verl_grpo_v7_dual_loop_q306b' \
  trainer.experiment_name='qwen3_0.6b_dual_questioner_v7_b4_n2' \
  trainer.n_gpus_per_node=1 \
  trainer.nnodes=1 \
  +data.apply_chat_template_kwargs.enable_thinking=False \
  trainer.save_freq=200 \
  ...
  trainer.total_training_steps=1000 \
  trainer.total_epochs=1000 \
  | tee qwen3_0.6b_dual_questioner_v7_b4_n2.log
```
